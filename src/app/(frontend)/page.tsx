  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        {loading ? (
          <Card className="p-12 text-center shadow-xl border border-slate-700 bg-slate-800/50 backdrop-blur-sm">
            <div className="animate-pulse">
              <div className="w-8 h-8 border-4 border-blue-500 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
              <p className="text-slate-300">Загрузка вопросов...</p>
            </div>
          </Card>
        ) : questions.length === 0 ? (
          <Card className="p-12 text-center shadow-xl border border-slate-700 bg-slate-800/50 backdrop-blur-sm">
            ...
            <p className="text-slate-200 mb-2 text-lg">Вопросов еще не добавлено</p>
            <p className="text-sm text-slate-400">
              Перейдите в{' '}
              <a href="/new-admin" className="text-blue-400 hover:text-blue-300 underline underline-offset-2">
                админ-панель
              </a>
          ...
          <>
            ...
            <div className="mt-10 flex justify-center">
              <Button
                ...
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-3 text-lg shadow-lg shadow-blue-500/25 transition-all hover:shadow-xl hover:shadow-blue-500/30"
              >
                Отправить ответы
              </Button>
            </div>
